...
public class modeHigher extends JFrame implements ActionListener{
    App app = new App();
    ...
    modeHigher(){
        ...
        //Title Label
        JLabel title = new JLabel("Pick the higher Number");
        ...
        JLabel info2 = new JLabel("Click on the bigger number");
        ...
        System.out.println(lblQuestion.getLocation());
        // Option 1 Button
        ...
        btnNum1.addActionListener(e-> {
            int result =funct.isBigger(Integer.valueOf(num1), Integer.valueOf(num2), true);
            modeHigher modHigher = new modeHigher();
            switch(result){
                case 1:
                    this.getContentPane().setBackground(Color.green);
                    JOptionPane.showMessageDialog(null, "Correct!", "Result",1);
                    this.dispose();
                    modHigher.setSize(500,200);
                    modHigher.setVisible(true);
                    break;
                case 2:
